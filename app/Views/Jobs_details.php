...
<body>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="single-slider section-overly slider-height2 d-flex align-items-center" data-background="<?= site_url(); ?>public/assets/images/background.jpg">
                <div class="container">
                    <section class="hero1">
                        ...
                        <div class="container">
                            ...
                            <div class="job-items">
                                <div class="company-img company-img-details">
                                    <a href="#"><img src="<?= site_url(); ?>public/assets/img/icon/job-list1.png" alt=""></a>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-4">
                                    <div class="post-details3  mb-50">
                                        ...
                                        <ul>
                                            ...
                                            <li>Location : <span><?=  ($tmp->workLocation ==1) ? "Remote" :CityData($tmp->city,$tmp->country)?></span></li>
                                          
                                            <li>Job nature : <span><?= JobType($tmp->type); ?></span></li>
                                        </ul>
                                        <div class="apply-btn2">
                                            <a class="form-control" style="background-color:#3E68EF;width:50%;color:whitesmoke" href="<?php echo site_url() ?>Home/Application/<?=$tmp->job_id;?>/0">Apply Now</a>
                                        </div>
                                    </div>
                                    <!-- <div class="post-details4  mb-50">
                                        ...
                                        <span>Syneins Enterprise System</span>
                                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                        <ul>
                                            <li>Name: <span>Syneins </span></li>
                                            <li>Web : <span>https://syneins.com</span></li>
